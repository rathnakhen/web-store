                    ...
                    <table class="min-w-full border-collapse block md:table">
                        ...
                        @foreach($users as $user)
                            ...
                            <tr class="border border-grey-500 md:border-none block md:table-row">
                                ...
                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">Name</span>{{$user->roles->pluck('name')->implode(',')}}</td>
